...
Upon measurement, the superposed market state $\large |\Psi\rangle$ collapses to a definite regime $\large |i\rangle$ with probability $\large |\Psi\_i|^2$, revealing the observed market condition.
