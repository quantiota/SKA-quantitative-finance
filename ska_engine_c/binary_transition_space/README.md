...
Wheeler said reality arises from yes/no questions. The market has been answering yes/no questions in 4-bit words since the first trade. The binary information flow is not a model of the market — it is the market, seen at the correct resolution.