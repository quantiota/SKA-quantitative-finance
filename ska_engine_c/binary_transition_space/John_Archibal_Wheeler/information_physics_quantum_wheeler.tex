...
\begin{itemize}[leftmargin=2em]
  \item Howcome existence?
  \item Howcome the quantum?
...
\begin{itemize}[leftmargin=2em]
  ...
  \item The super-Copernicanprinciple.
  \item "Consciousness"
...
overview, taking for workinghypothesis the most effective one that has survived this
...
= 2vr x (shift of interference pattern, measured in number of fringes)
= (electron charge) x (magnetic flux embraced)/fie
(19.1)
Here H = 1.0546 x 10 27 gcrn2/s is the quantum in conventional units, or in ge-
ometric units [4, 16] --- where both time and mass are measured in the units of
length --- f i = f i c = 2.612 x 10\textasciitilde{}66 cm2 = the square of the Planck length, 1.616 x
10\textasciitilde{}33 = what we hereafter term the Planck area.
Not only in electrodynamics but also in geornetrodynamics and in every other
...
at all to a bit seems to show itself. Therefore we look closer. The idea behind th«
operation of the instrument is simple. A wire of length I carries a current i through
...
blackhole, of Bekenstein number N and horizon area 4NHlogs2, was put together. Symbol,
also, in a broader sense, of the theme that every physical entity, every it, derives from bits.
Reproduced from JGST, p.220.}
\end{figure}

a magnetic field B that runs perpendicular to it. In consequence the piece ofcopper
...
p - Blit
= (flux per unit z) x (charge, e,of the elementary carrier of current)
...
(Fig. 19.1) into domains each of size 4fUoge2, that is, 2.77... times the Planck area,
...
of which particular one of 2N configurations it was put together. Its size, an it, is
fixed by the number, N, of bits of information hidden within it.
The quantum, H, in whatever correct physics formula it appears, thus serves as
...
How come a value for the quantum so small as H = 2.612 x 10\textasciitilde{}66 cm2? As well
as ask why the speed of light is so great as c = 3 x 1010 cm/s! No such constant
...
Nature's great simplicities. Likewise with H\textbackslash{}y equation that contains an H
...
that point we will revalue H = 2.612 x 10\textasciitilde{}66 cm2 --- as we downgrade c = 3 x 1010
...
bringing about what seerns to be happening to us," but Leibniz [70] reassures us,
...
nothing of this kind more obviouslyoffers itself than the principlethat 'the boundary
...
Hermann Weyl tells us, "taxes the strength of our faith hardly less than the doc-
...
our account of the flux of existence... The conceptual scheme of physical objects
...
geometry quantum theory, weknow, imposes fluctuations [13,14, 82]. Moreover, the
...
316 JOHN ARCHIBALD WHEELER. THE SEARCH FOR LINKS 317
level answer. So it is in the game of twenty questions in its surprise version [89].
...
quantity e2 /He - 1/137.036..., a "constant" which --- for extreme conditions ---
...
chamber, dust particle through 3°K-backgroundradiation or Moon through space.
...
approximate --- and derived from bits via informationtheory.
...
familiar Hilbert space with its familiar complexprobability amplitudes from the twin
...
What about probabilities of a Bayesian cast, probabilities "interpreted not asfre-
...
participates in the making of meaning, meaning in the sense of F011esdal [124],
...
radius 13.2 x 109 light years (uncertainty <35\%) [130] or 1.25 x 1028 cm and of
volume 27T2 radius3,
(number of bits) = (log\textasciicircum{}e) x (number of nats)
= (log\textasciicircum{}e) x (entropy /Boltzmann's constant,/:)
= 1.44... x [(Sir4/45)(radius. kT/Kc)3]
= 8 x 1088
(19.3)
It would be totally out of place to compare this overpoweringnumber with the num-
...
to be occupied. How far foot and ferry have carried rneaning\textasciicircum{}making communica-
...
320 JOHN ARCHIBALD WHEELER.
Fourth clue: "Consciousness". We have traveled what may seem a dizzyingpath.
...
establish meaning. Fourth, from the past through the billeniurns to come, so many
...
Peirce [144]. Parmenides of Elea [145] (« 515B.C.- 450+ B.C.) may tell us that
...
F011esdal's guideline [124], "Meaning is the joint product of all the evidence that is
...
meaning."
F011esdaTs statement supplies, not an answer, but the doorway to new questions.
...
F011esdal's statement posses greater challenge to reflection than "communication,"
...
a sufficiently large number of H20 molecules collected in a box will manifest solid,
...
(1) the 0-or-l sharpness of definition of bit number nineteen in a string of binary
digits, or (2) the accordion property of a mathematical theorem, the length ofwhich,
...
of this report I thank E. L. Bennett and NSF grant PHY245-6243to Princeton
...
May-2 June and 4-8 June 1989 and at the 3rd International Symposium on Founda-
tions of Quantum Mechanics in the Light of New Technology, Tokyo, 28-31 August
...
at the 20-22 April 1989 annual meeting of Benjamin Franklin's "American Philo-
sophical Society, held at Philadelphia for Promoting Useful Knowledge," and the
...
NSF Grant PHY 245-6243to Princeton University.
\section*{Discussion}
...
quantized N0/log(l + z) relation --- correlation with galaxies (Arp) --- angu-
lar correlation with brightest nearby galaxies (Burbidgeet al.)
...
J.A. Wheeler.
1. The book by Thome and colleagues,"Black Holes: The Membrane Paradigm,"
...
to produce quasars.
2. No one has discovered a way to get a particle of wave length A from point
A through empty flat space to a point B at a great distance L without its
undergoing on the way a transverse spread of the order \textasciicircum{}/L\textbackslash{}. This spread
...
\begin{thebibliography}{180}
	...
	\bibitem{5}
	J. G. Mendel: ``Versuche über Pflanzenhybriden'' \emph{Verhandlungen des Naturforschenden Vereins in Brünn} 4 (1866).
	...
	\bibitem{19}
	J. A. Wheeler: ``Include the observer in the wave function?'' \emph{Fundamenta Scientiae: Séminaire sur les fondements des sciences} (Strasbourg) \textbf{25} (1976) 9--35; reprinted in \emph{Quantum Mechanics A Half Century Later}, eds. J. Leite Lopes and M. Paty (Reidel, Dordrecht, 1977) p.1--18.
