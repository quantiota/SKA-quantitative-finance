...
\begin{document}
	...
	\begin{figure}[htbp]
		\centering
		\includegraphics[width=0.6\linewidth]{wheeler.png} % Note: replace with actual image path if available; this assumes the figure file from the original PDF source is included in the same directory
	...
	(Fig. 19.1) into domains each of size $4\hbar \ln 2$, that is, $2.77\ldots$ times the Planck area,
	...
	made a table no less solid when they told us it was $99.9\ldots$ percent emptiness.
	...
	quantity $e^2 / \hbar c \approx 1/137.036\ldots$, a ``constant'' which---for extreme conditions---
	...
	\begin{align*}
		...
		&= 1.44\ldots \times [(8\pi^4/45)(\text{radius} \cdot kT/\hbar c)^3] \\
		&= 8 \times 10^{88}
		\tag{19.3}
	\end{align*}
